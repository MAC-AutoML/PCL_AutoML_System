...
from bayesmark.DeepNet_funcs import DeepNet
...
def run_DeepNet_study(
        opt_class, opt_kwargs, model_name, dataset,  n_calls, n_suggestions, data_root=None, api_config, callback=None,
):
...
def experiment_main(opt_class, args=None):  # pragma: main
    ...
    function_evals, timing, suggest_log = run_DeepNet_study(
        ...
        api_config=args[CmdArgs.api_config],
        callback=callback,
    )
