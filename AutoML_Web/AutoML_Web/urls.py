...
urlpatterns = [
    ...
    url(r'api/trainJobManage',views.TrainJobManage.as_view(),name='train_job_manage'),
    url(r'api/autoJobManage',views.AutoJobManage.as_view(),name='search_job_manage'),
    ...
    url(r'api/refresh/resource',views.RefreshResource.as_view(),name='refresh_algo'),
    url(r'api/refresh/method',views.RefreshMethod.as_view(),name='refresh_algo'),
